...
void GenerateInputTree_PhaseSpaceDecay_25o(Double_t Erel_in=1.0, 
					   Double_t E_in=200){
  // parameteres
  ...
  const Double_t Masses[Ndecay] = {22370.8, 939.565};
  ...
  TFile *file = new TFile("root/examples/inputtree_25o_example.root","recreate");
