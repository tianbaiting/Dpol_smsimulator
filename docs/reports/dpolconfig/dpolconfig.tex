...
\begin{frame}
    ...
    i should use geant4 code to do cross check with my Runge-Kutta code that caculate the deutron trajectory.
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\linewidth]{figures/2026-01-26-04-22-34.png}
	\caption{Caption}
	\label{fig:2026-01-26-04-22-34}
\end{figure}
...
% -------------------------------------------------------------------
% Magnetic Field B = 2.0 T (Satisfies Requirement)
% -------------------------------------------------------------------
\begin{frame}[allowframebreaks]{Simulation Scan: B = 2.0 T (Baseline)}
    \centering
    % 2.0 deg
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B200T_2.0deg.png}
        \caption{protons\_B200T\_2.0deg.png}
    \end{figure}
    
    % 4.0 deg
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B200T_4.0deg.png}
        \caption{protons\_B200T\_4.0deg.png}
    \end{figure}

    % 6.0 deg
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B200T_6.0deg.png}
        \caption{protons\_B200T\_6.0deg.png}
    \end{figure}

    % 8.0 deg
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B200T_8.0deg.png}
        \caption{protons\_B200T\_8.0deg.png}
    \end{figure}

    % 10.0 deg
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B200T_10.0deg.png}
        \caption{protons\_B200T\_10.0deg.png}
    \end{figure}
\end{frame}

% -------------------------------------------------------------------
% Magnetic Field B = 1.6 T (Below Requirement)
% -------------------------------------------------------------------
\begin{frame}[allowframebreaks]{Simulation Scan: B = 1.6 T}
    \centering
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B160T_2.0deg.png}
        \caption{protons\_B160T\_2.0deg.png}
    \end{figure}
    
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B160T_4.0deg.png}
        \caption{protons\_B160T\_4.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B160T_6.0deg.png}
        \caption{protons\_B160T\_6.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B160T_8.0deg.png}
        \caption{protons\_B160T\_8.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B160T_10.0deg.png}
        \caption{protons\_B160T\_10.0deg.png}
    \end{figure}
\end{frame}
...
% -------------------------------------------------------------------
\begin{frame}[allowframebreaks]{Simulation Scan: B = 1.2 T}
    \centering
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B120T_2.0deg.png}
        \caption{protons\_B120T\_2.0deg.png}
    \end{figure}
    
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B120T_4.0deg.png}
        \caption{protons\_B120T\_4.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B120T_6.0deg.png}
        \caption{protons\_B120T\_6.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B120T_8.0deg.png}
        \caption{protons\_B120T\_8.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B120T_10.0deg.png}
        \caption{protons\_B120T\_10.0deg.png}
    \end{figure}
\end{frame}
...
% -------------------------------------------------------------------
\begin{frame}[allowframebreaks]{Simulation Scan: B = 1.0 T}
    \centering
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B100T_2.0deg.png}
        \caption{protons\_B100T\_2.0deg.png}
    \end{figure}
    
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B100T_4.0deg.png}
        \caption{protons\_B100T\_4.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B100T_6.0deg.png}
        \caption{protons\_B100T\_6.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B100T_8.0deg.png}
        \caption{protons\_B100T\_8.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B100T_10.0deg.png}
        \caption{protons\_B100T\_10.0deg.png}
    \end{figure}
\end{frame}

% -------------------------------------------------------------------
% Magnetic Field B = 0.8 T (Worst Case)
% -------------------------------------------------------------------
\begin{frame}[allowframebreaks]{Simulation Scan: B = 0.8 T}
    \centering
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B080T_2.0deg.png}
        \caption{protons\_B080T\_2.0deg.png}
    \end{figure}
    
    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B080T_4.0deg.png}
        \caption{protons\_B080T\_4.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B080T_6.0deg.png}
        \caption{protons\_B080T\_6.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B080T_8.0deg.png}
        \caption{protons\_B080T\_8.0deg.png}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.6\linewidth]{figures/geant4proton/protons_B080T_10.0deg.png}
        \caption{protons\_B080T\_10.0deg.png}
    \end{figure}
\end{frame}
