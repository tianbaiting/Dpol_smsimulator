...
$N_{+}$/$N_{-}$ are the counts of $\Delta p_x^{\mathrm{reco}}>0$/$<0$ events, $\sigma(R)_{\mathrm{sim}}$ is the statistical error of the current MC sample, and $\sigma(R)_{16\mathrm{h}}$ is the error extrapolated to a 16 h run (formula in the Statistics and Beam Time section).
...
\section{Technical Conventions: Coordinates, $p_x$, and Reaction Plane}
