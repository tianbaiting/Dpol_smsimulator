...
\midrule
NN \textcolor{red}{(contaminated model)} & 5 & 21.04 & 15.56 & 3.10 \\
...
\vspace{0.1cm}
On this fixture, the NN branch is currently the strongest point estimator, while the RK modes still need calibration or configuration tuning for this truth-grid operating point. \textcolor{red}{Audit note 2026-04-20: the NN row was produced by the deleted polluted model; the clean retrain is expected to keep (and likely extend) its point-estimate lead, especially on $p_x,p_y$. Also note RK numbers here predate the 2026-04-16 RK bugfix --- see \texttt{rk\_reconstruction\_status\_20260416} for current RK.}
\end{frame}
