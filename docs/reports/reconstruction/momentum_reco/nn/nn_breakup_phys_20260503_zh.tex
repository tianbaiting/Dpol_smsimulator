...
\begin{itemize}[nosep]
    ...
    \item \texttt{NEBULAReconstructor::ApplyPositionSmearing} 叠 5 mm 的高斯抖动远小于 12 cm bar 间距, 离散性几乎没被抹掉; 12 cm / $L_\text{NEBULA}=7.25$ m $\times |\vec p|\approx 600$ MeV/$c$ $\to$ Δ$p_x$ 矩形宽 $\sim\pm 5$ MeV/$c$, 与观测一致.
