...
\multicolumn{6}{l}{Veto count: $10$/wall (online-monitor Spectra uses 20-bin VETO ID histogram,
                   i.e.\ $2\times10$)}\\
...
Total: $22+22+23+23 = 90$ Neut bars + $20$ Veto bars = $\mathbf{110}$ counters,
...
shown below verbatim; the per-bar file has 110 rows ($90+20$) following the
