...
void analysis_25o_crosstalk_example(TString filename="root/wall/nebula_neuland_1_25o_psdecay_0000.root",
...
Double_t CalcErel(TLorentzVector P24o, TClonesArray *PlaArray){
  ...
  if (PlaArray->GetEntries()<1) return -1000;
  ...
  TArtNEBULAPla *pla = (TArtNEBULAPla*)PlaArray->At(0);
