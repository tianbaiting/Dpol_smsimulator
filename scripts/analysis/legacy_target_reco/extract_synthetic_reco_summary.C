// [EN] Usage: root -l -b -q 'scripts/analysis/legacy_target_reco/extract_synthetic_reco_summary.C+("analysis.root","summary.csv")' / [CN] 用法: root -l -b -q 'scripts/analysis/legacy_target_reco/extract_synthetic_reco_summary.C+("analysis.root","summary.csv")'
