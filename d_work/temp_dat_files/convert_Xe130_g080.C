...
void convert_Xe130_g080() {
    ...
    TFile *f = new TFile("/home/tian/workspace/dpol/smsimulator5.5/d_work/rootfiles/ypol_native/ypol_np_Xe130_g080.root", "RECREATE");
    ...
    std::cout << "Converted " << eventCount << " events to " << "/home/tian/workspace/dpol/smsimulator5.5/d_work/rootfiles/ypol_native/ypol_np_Xe130_g080.root" << std::endl;
}
