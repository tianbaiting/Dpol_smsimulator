...
void convert_Xe130_g050() {
    ...
    TFile *f = new TFile("/home/tian/workspace/dpol/smsimulator5.5/d_work/rootfiles/ypol_native/ypol_np_Xe130_g050.root", "RECREATE");
    ...
    std::cout << "Converted " << eventCount << " events to " << "/home/tian/workspace/dpol/smsimulator5.5/d_work/rootfiles/ypol_native/ypol_np_Xe130_g050.root" << std::endl;
}
