...
void convert_Xe130_g050() {
    std::string inputFile = "/home/tian/workspace/dpol/smsimulator5.5/d_work/temp_dat_files/Xe130_g050.dat";
    ...
    TFile *f = new TFile("/home/tian/workspace/dpol/smsimulator5.5/d_work/rootfiles/ypol_sle_rotate_back/ypol_np_Xe130_g050.root", "RECREATE");
    ...
    std::cout << "Converted " << eventCount << " events to " << "/home/tian/workspace/dpol/smsimulator5.5/d_work/rootfiles/ypol_sle_rotate_back/ypol_np_Xe130_g050.root" << std::endl;
}
