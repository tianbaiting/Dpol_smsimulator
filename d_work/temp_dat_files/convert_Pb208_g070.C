...
void convert_Pb208_g070() {
    std::string inputFile = "/home/tian/workspace/dpol/smsimulator5.5/d_work/temp_dat_files/Pb208_g070.dat";
    ...
    TFile *f = new TFile("/home/tian/workspace/dpol/smsimulator5.5/d_work/rootfiles/ypol_sle_rotate_back/ypol_np_Pb208_g070.root", "RECREATE");
    ...
    std::cout << "Converted " << eventCount << " events to " << "/home/tian/workspace/dpol/smsimulator5.5/d_work/rootfiles/ypol_sle_rotate_back/ypol_np_Pb208_g070.root" << std::endl;
}
